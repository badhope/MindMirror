    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 py-12 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
      ...
      <FadeInSection className="mb-12">
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-white/10">
          <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">心理学：探索心灵的科学</h2>
      ...
      <FadeInSection>
        <h2 className="text-xl sm:text-2xl font-bold text-white mb-6">主要学派</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {majorSchools.map((school, index) => (
            ...
            >
              ...
              <p className="text-blue-400 text-sm mb-2">创始人：{school.founder}</p>
              <p className="text-white/60 leading-relaxed mb-2">{school.description}</p>
              <p className="text-white/40 text-sm">影响：{school.influence}</p>
            </motion.div>
          ))}
        </div>
      </FadeInSection>
