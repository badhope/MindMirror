    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 py-12 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
      ...
      <FadeInSection className="mb-12">
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-white/10">
          <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">哲学：爱智慧之学</h2>
      ...
      <FadeInSection className="mb-12">
        <h2 className="text-xl sm:text-2xl font-bold text-white mb-6">发展历程</h2>
      ...
      <FadeInSection className="mb-12">
        <h2 className="text-xl sm:text-2xl font-bold text-white mb-6">东方哲学</h2>
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {easternPhilosophy.map((region, index) => (
            ...
            >
              ...
              <p className="text-amber-400 text-sm mb-3">{region.period}</p>
              <p className="text-white/60 leading-relaxed mb-3">{region.description}</p>
              <div className="flex flex-wrap gap-2">
      ...
      <FadeInSection>
        <h2 className="text-xl sm:text-2xl font-bold text-white mb-6">哲学的核心问题</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {majorQuestions.map((q, index) => (
            <motion.div
              ...
              className="bg-white/5 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-white/10"
            >
              <h3 className="text-base sm:text-lg font-semibold text-white mb-2">{q.question}</h3>
              <p className="text-white/60 leading-relaxed">{q.description}</p>
            </motion.div>
          ))}
        </div>
      </FadeInSection>
