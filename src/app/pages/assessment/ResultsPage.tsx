    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-violet-950/20 to-slate-950 pt-16 sm:pt-20 md:pt-24 pb-8 sm:pb-12">
      <div id="result-export-container" className="max-w-6xl mx-auto px-3 sm:px-4 md:px-6">
        ...
        >
          ...
          <motion.button
            onClick={() => navigate('/app/assessments')}
            className="flex items-center gap-2 px-5 sm:px-8 py-2.5 sm:py-4 rounded-xl bg-white/5 backdrop-blur-sm text-white text-sm sm:text-base font-semibold hover:bg-white/10 border border-white/20 transition-all"
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98 }}
            type="button"
          >
