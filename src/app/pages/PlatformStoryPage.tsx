    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 py-12 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
      ...
      <FadeInSection className="mb-12">
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-white/10">
          <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">我们的愿景</h2>
      ...
      <FadeInSection className="mb-12">
        <h2 className="text-xl sm:text-2xl font-bold text-white mb-6">核心价值观</h2>
      ...
      <FadeInSection>
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-white/10">
          <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">我们的团队</h2>
          <p className="text-white/70 leading-relaxed mb-4">
