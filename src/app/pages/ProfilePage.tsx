...
import { useUserStore, useAssessmentStore, useAchievementStore } from '@store'
...
export default function ProfilePage() {
  ...
  const { user, setUser, updateUser } = useUserStore((state) => state)
  const { completedAssessments, addCompletedAssessment, deleteAssessment } = useAssessmentStore((state) => state)
  const { achievements, updateAchievementProgress } = useAchievementStore((state) => state)
  ...
  }, [completedAssessments, achievements])
