...
export default function IdeologyHistoryPage() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 py-12 px-4 sm:px-6 lg:px-8 max-w-5xl mx-auto">
      <motion.div
      ...
      <FadeInSection className="mb-12">
        <div className="bg-white/5 backdrop-blur-sm rounded-2xl p-6 sm:p-8 border border-white/10">
          <h2 className="text-xl sm:text-2xl font-bold text-white mb-4">意识形态：思想的武器</h2>
      ...
      <FadeInSection className="mb-12">
        <h2 className="text-xl sm:text-2xl font-bold text-white mb-6">意识形态发展历程</h2>
      ...
      <FadeInSection className="mb-12">
        <h2 className="text-xl sm:text-2xl font-bold text-white mb-6">主要意识形态</h2>
          ...
          {majorIdeologies.map((ideology, index) => (
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-pink-400 text-sm">{ideology.origin}</span>
              </div>
              <p className="text-white/60 leading-relaxed mb-2">{ideology.description}</p>
              ...
              <p className="text-white/40 text-sm">影响：{ideology.influence}</p>
            </motion.div>
          ))}
        </div>
      </FadeInSection>
      ...
      <FadeInSection>
        <h2 className="text-xl sm:text-2xl font-bold text-white mb-6">意识形态的功能</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          {ideologicalFunctions.map((item, index) => (
            <motion.div
              ...
              className="bg-white/5 backdrop-blur-sm rounded-xl p-4 sm:p-6 border border-white/10"
            >
              <h3 className="text-base sm:text-lg font-semibold text-white mb-2">{item.function}</h3>
