...
export const hollandProfessionalQuestions: ProfessionalQuestionSet = {
  normal: [
    ...
    createHollandQuestion('hol-r-8', '我喜欢做手工制作', 'R'),
    createHollandQuestion('hol-r-9', '我对技术工作感兴趣', 'R'),
    createHollandQuestion('hol-r-10', '我喜欢维修和保养设备', 'R'),
    createHollandQuestion('hol-r-11', '我喜欢户外劳动', 'R'),
    createHollandQuestion('hol-r-12', '我擅长使用各种工具', 'R'),
    createHollandQuestion('hol-r-13', '我喜欢实际操作', 'R'),
    createHollandQuestion('hol-r-14', '我对机械原理感兴趣', 'R'),
    createHollandQuestion('hol-r-15', '我喜欢解决实际问题', 'R'),

    // I: 研究型 (Investigative) - 15题
    ...
    createHollandQuestion('hol-i-8', '我喜欢探索事物的本质', 'I'),
    createHollandQuestion('hol-i-9', '我对研究工作感兴趣', 'I'),
    createHollandQuestion('hol-i-10', '我喜欢逻辑分析', 'I'),
    createHollandQuestion('hol-i-11', '我对自然科学感兴趣', 'I'),
    createHollandQuestion('hol-i-12', '我喜欢思考抽象概念', 'I'),
    createHollandQuestion('hol-i-13', '我对科学发现感兴趣', 'I'),
    createHollandQuestion('hol-i-14', '我喜欢解决智力问题', 'I'),
    createHollandQuestion('hol-i-15', '我喜欢独立研究', 'I'),
    ...
    createHollandQuestion('hol-a-8', '我喜欢艺术创作', 'A'),
    createHollandQuestion('hol-a-9', '我对文学艺术感兴趣', 'A'),
    createHollandQuestion('hol-a-10', '我喜欢创新和想象', 'A'),
    ...
    createHollandQuestion('hol-s-8', '我喜欢帮助他人', 'S'),
    createHollandQuestion('hol-s-9', '我对人际关系感兴趣', 'S'),
    createHollandQuestion('hol-s-10', '我喜欢与人交流', 'S'),

    // E: 企业型 (Enterprising) - 10题
    ...
    createHollandQuestion('hol-e-8', '我喜欢竞争和挑战', 'E'),
    createHollandQuestion('hol-e-9', '我对商业活动感兴趣', 'E'),
    createHollandQuestion('hol-e-10', '我喜欢影响他人', 'E'),

    // C: 常规型 (Conventional) - 10题
    ...
    createHollandQuestion('hol-c-8', '我喜欢有条理的工作', 'C'),
    createHollandQuestion('hol-c-9', '我对数据处理感兴趣', 'C'),
    createHollandQuestion('hol-c-10', '我喜欢系统化的工作', 'C'),
  ],
  advanced: [
    // R: 现实型 (Realistic) - 18题
    createHollandQuestion('hol-r-1', '我喜欢使用工具和机械进行工作', 'R'),
    ...
    createHollandQuestion('hol-r-14', '我对机械原理感兴趣', 'R'),
    createHollandQuestion('hol-r-15', '我喜欢解决实际问题', 'R'),
    createHollandQuestion('hol-r-16', '我对工程技术感兴趣', 'R'),
    createHollandQuestion('hol-r-17', '我喜欢动手实践', 'R'),
    createHollandQuestion('hol-r-18', '我对实用技术感兴趣', 'R'),

    // I: 研究型 (Investigative) - 18题
    createHollandQuestion('hol-i-1', '我喜欢探索科学问题和理论', 'I'),
    createHollandQuestion('hol-i-2', '我善于分析和解决复杂问题', 'I'),
    createHollandQuestion('hol-i-3', '我对数学和科学有浓厚兴趣', 'I'),
    createHollandQuestion('hol-i-4', '我喜欢阅读科学文献和研究报告', 'I'),
    ...
    createHollandQuestion('hol-i-14', '我喜欢解决智力问题', 'I'),
    createHollandQuestion('hol-i-15', '我喜欢独立研究', 'I'),
    createHollandQuestion('hol-i-16', '我对科学研究感兴趣', 'I'),
    createHollandQuestion('hol-i-17', '我喜欢探索未知', 'I'),
    createHollandQuestion('hol-i-18', '我对理论研究感兴趣', 'I'),
    ...
    createHollandQuestion('hol-a-9', '我对文学艺术感兴趣', 'A'),
    createHollandQuestion('hol-a-10', '我喜欢创新和想象', 'A'),
    createHollandQuestion('hol-a-11', '我对视觉艺术感兴趣', 'A'),
    createHollandQuestion('hol-a-12', '我喜欢艺术表达', 'A'),
    createHollandQuestion('hol-a-13', '我对创意设计感兴趣', 'A'),
    createHollandQuestion('hol-a-14', '我喜欢艺术欣赏', 'A'),
    createHollandQuestion('hol-a-15', '我对表演艺术感兴趣', 'A'),
    createHollandQuestion('hol-a-16', '我喜欢创意表达', 'A'),
    createHollandQuestion('hol-a-17', '我对艺术创作感兴趣', 'A'),
    createHollandQuestion('hol-a-18', '我喜欢想象和创造', 'A'),
    ...
    createHollandQuestion('hol-s-9', '我对人际关系感兴趣', 'S'),
    createHollandQuestion('hol-s-10', '我喜欢与人交流', 'S'),
    createHollandQuestion('hol-s-11', '我对社会服务感兴趣', 'S'),
    createHollandQuestion('hol-s-12', '我喜欢与人合作', 'S'),
    createHollandQuestion('hol-s-13', '我对社区服务感兴趣', 'S'),
    createHollandQuestion('hol-s-14', '我喜欢关怀他人', 'S'),
    createHollandQuestion('hol-s-15', '我对教育事业感兴趣', 'S'),
    createHollandQuestion('hol-s-16', '我喜欢与人互动', 'S'),
    createHollandQuestion('hol-s-17', '我对医疗服务感兴趣', 'S'),
    createHollandQuestion('hol-s-18', '我喜欢帮助别人成长', 'S'),

    // E: 企业型 (Enterprising) - 18题
    createHollandQuestion('hol-e-1', '我喜欢领导和管理他人', 'E'),
    createHollandQuestion('hol-e-2', '我善于说服和影响他人', 'E'),
    createHollandQuestion('hol-e-3', '我对商业和创业感兴趣', 'E'),
    createHollandQuestion('hol-e-4', '我喜欢制定计划和目标', 'E'),
    ...
    createHollandQuestion('hol-e-9', '我对商业活动感兴趣', 'E'),
    createHollandQuestion('hol-e-10', '我喜欢影响他人', 'E'),
    createHollandQuestion('hol-e-11', '我对创业创新感兴趣', 'E'),
    createHollandQuestion('hol-e-12', '我喜欢组织活动', 'E'),
    createHollandQuestion('hol-e-13', '我对项目管理感兴趣', 'E'),
    createHollandQuestion('hol-e-14', '我喜欢推动事情发展', 'E'),
    createHollandQuestion('hol-e-15', '我对企业管理感兴趣', 'E'),
    createHollandQuestion('hol-e-16', '我喜欢说服他人', 'E'),
    createHollandQuestion('hol-e-17', '我对投资和经营感兴趣', 'E'),
    createHollandQuestion('hol-e-18', '我喜欢追求成就', 'E'),

    // C: 常规型 (Conventional) - 18题
    createHollandQuestion('hol-c-1', '我喜欢有秩序和结构的工作环境', 'C'),
    createHollandQuestion('hol-c-2', '我善于处理数据和文件', 'C'),
    createHollandQuestion('hol-c-3', '我对会计和行政工作感兴趣', 'C'),
    createHollandQuestion('hol-c-4', '我喜欢遵循既定的程序和规则', 'C'),
    ...
    createHollandQuestion('hol-c-9', '我对数据处理感兴趣', 'C'),
    createHollandQuestion('hol-c-10', '我喜欢系统化的工作', 'C'),
    createHollandQuestion('hol-c-11', '我对档案管理感兴趣', 'C'),
    createHollandQuestion('hol-c-12', '我喜欢按部就班的工作', 'C'),
    createHollandQuestion('hol-c-13', '我对数据录入感兴趣', 'C'),
    createHollandQuestion('hol-c-14', '我喜欢有条理的安排', 'C'),
    createHollandQuestion('hol-c-15', '我对财务工作感兴趣', 'C'),
    createHollandQuestion('hol-c-16', '我喜欢规范化的工作', 'C'),
    createHollandQuestion('hol-c-17', '我对统计工作感兴趣', 'C'),
    createHollandQuestion('hol-c-18', '我喜欢秩序和规律', 'C'),
  ],
  professional: [
    // R: 现实型 (Realistic) - 20题
    createHollandQuestion('hol-r-1', '我喜欢使用工具和机械进行工作', 'R'),
    ...
    createHollandQuestion('hol-r-17', '我喜欢动手实践', 'R'),
    createHollandQuestion('hol-r-18', '我对实用技术感兴趣', 'R'),
    createHollandQuestion('hol-r-19', '我对机械维修感兴趣', 'R'),
    createHollandQuestion('hol-r-20', '我喜欢技术操作', 'R'),
    ...
    createHollandQuestion('hol-i-17', '我喜欢探索未知', 'I'),
    createHollandQuestion('hol-i-18', '我对理论研究感兴趣', 'I'),
    createHollandQuestion('hol-i-19', '我对数据分析感兴趣', 'I'),
    createHollandQuestion('hol-i-20', '我喜欢科学探索', 'I'),
    ...
    createHollandQuestion('hol-a-17', '我对艺术创作感兴趣', 'A'),
    createHollandQuestion('hol-a-18', '我喜欢想象和创造', 'A'),
    createHollandQuestion('hol-a-19', '我对艺术设计感兴趣', 'A'),
    createHollandQuestion('hol-a-20', '我喜欢艺术灵感', 'A'),
    ...
    createHollandQuestion('hol-s-17', '我对医疗服务感兴趣', 'S'),
    createHollandQuestion('hol-s-18', '我喜欢帮助别人成长', 'S'),
    createHollandQuestion('hol-s-19', '我对人际关系指导感兴趣', 'S'),
    createHollandQuestion('hol-s-20', '我喜欢帮助他人发展', 'S'),
    ...
    createHollandQuestion('hol-e-17', '我对投资和经营感兴趣', 'E'),
    createHollandQuestion('hol-e-18', '我喜欢追求成就', 'E'),
    createHollandQuestion('hol-e-19', '我对商业战略感兴趣', 'E'),
    createHollandQuestion('hol-e-20', '我喜欢领导团队', 'E'),
    ...
    createHollandQuestion('hol-c-17', '我对统计工作感兴趣', 'C'),
    createHollandQuestion('hol-c-18', '我喜欢秩序和规律', 'C'),
    createHollandQuestion('hol-c-19', '我对文档管理感兴趣', 'C'),
    createHollandQuestion('hol-c-20', '我喜欢数据整理', 'C'),
  ],
}
