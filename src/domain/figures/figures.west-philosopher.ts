...
export const FIGURES_WEST_PHILOSOPHER: readonly Figure[] = [
  ...
  },
  {
    ...
    signature: 'Die Philosophen haben die Welt nur verschieden interpretiert; es kömmt drauf an, sie zu verändern.',
    ...
    anecdotes: [
      { title: '共产党宣言', body: '1848 年与恩格斯合著《共产党宣言》，「全世界的无产者，联合起来！」' },
  ...
  },
  {
    ...
    anecdotes: [
      ...
      { title: '是毁是颂', body: '自题墓志铭：「生于 1711 年，卒于——；《人性论》《自然宗教对话录》作者。」' },
    ],
